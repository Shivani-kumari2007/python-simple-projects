...
This repository contains beginner-friendly Python projects created to practice core programming concepts and logic building. These projects are ideal for students, beginners, and first-time GitHub users.

Projects Included
 1. To-Do List Application.
    A console-based program where users can manage daily tasks.
    Location: todo-list/todo.py
 ...
 2. Simple Calculator.
    ...
    Concepts: Functions, User input, and Conditional logic.

 4. Greeting Program.
    A script that greets the user based on the current time.
    Location: greeting-program/greeting.py
 ...
 How to Run the Projects:
  ...
  -Navigate to the project folder and run: python filename.py.

 -Purpose of This Repository
  1.Practice Python fundamentals.
  2.Understand logic building.
